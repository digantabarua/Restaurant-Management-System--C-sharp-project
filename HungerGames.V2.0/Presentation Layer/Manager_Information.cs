...
{
    public partial class Manager_Information : Form
    {
        ...
        private void Manager_Information_FormClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }
        ...
        private void Manager_Information_Load(object sender, EventArgs e)
        {
